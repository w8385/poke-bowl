      ...
      <section className="grid gap-4 rounded-2xl border border-zinc-200 bg-zinc-50 p-6 sm:grid-cols-3 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div>
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            {item.altBalls.length ? item.altBalls.map((ballKey) => <BallChip key={ballKey} ballKey={ballKey} />) : <p className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">투표 후보에서 선택 가능</p>}
          </div>
        </div>
      </section>
